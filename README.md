<table>
  <tr>
    <td><img src="icon.png" width="256" height="256" alt="vscode-windows icon"></td>
    <td>
      <h1>vscode-windows</h1>
      <p><strong>vscode-windows</strong> is a VSCode extension that lets you open multiple <strong>floating Monaco editors</strong> in a single panel. Each editor window is draggable, resizable, and supports zooming and panning across the workspace.</p>
      <blockquote>
        ⚠️ <strong>Important:</strong> These are <strong>Monaco editors embedded in a webview</strong>, not native VSCode editors. You <strong>cannot apply your VSCode theme</strong> fully, and some editor features/settings may not work. The extension only approximates the VSCode look.
      </blockquote>
    </td>
  </tr>
</table>
