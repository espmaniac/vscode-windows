...
function activate(context) {
  ...
  async function createMonacoWindow(fileUri) {
    ...
    if (!panel) {
      ...
      const monacoUri = vscode.Uri.joinPath(
        context.extensionUri,
        'src', 'vs'
      );
      const loaderJsUri = panel.webview.asWebviewUri(vscode.Uri.joinPath(monacoUri, 'loader.js'));
      const vsUri = panel.webview.asWebviewUri(monacoUri);
            ...
            require(['vs/editor/editor.main'], () => {
                ...
                function applyVSCodeTheme() {
                    ...
                    if (typeof monaco.editor.setTheme === 'function') {
                        ...
                        console.error("monaco.editor.setTheme is not available");
                    }
                }
